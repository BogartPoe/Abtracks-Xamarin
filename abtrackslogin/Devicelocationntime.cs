...
{
    [Activity(Label = "Devicelocationntime")]
    public class Devicelocationntime : Activity
    {
        ...
        private const string FirebaseURL = "https://abtracks-210404.firebaseio.com/haabi37wgcv/"; //Firebase Database URL
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Devicelocationntime);
            ...
            list_data.ItemClick += (s, e) =>
            {
                ...
                // StartActivity(new Intent(this, typeof(Devicelocationdate)));
