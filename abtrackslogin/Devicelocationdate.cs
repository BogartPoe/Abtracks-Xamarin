...
{
    [Activity(Label = "Devicelocationdate")]
    public class Devicelocationdate : Activity
    {
        ...
        private const string FirebaseURL = "https://abtracks-210404.firebaseio.com/"; //Firebase Database URL
        ...
        Devicelistlog dlistlog = new Devicelistlog();
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Devicelocationdate);
            ...
            list_data.ItemClick += (s, e) =>
            {
                ...
                // changing to ViewMap form
                 StartActivity(new Intent(this, typeof(Devicelocationntime)));
